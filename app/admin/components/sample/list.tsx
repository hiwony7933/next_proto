...
import AdminSearchLayout from '../common/adminSearchLayout';
...
export default function SampleList() {
  ...
  return (
    <div>
      <AdminSearchLayout title="샘플 리스트 검색" onSearch={handleSearch} />
      <GridList title="샘플 리스트" />
    </div>
  );
}
...
const GridList = ({ title }: { title: string }) => {
