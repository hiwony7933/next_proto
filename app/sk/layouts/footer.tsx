    ...
    <footer className={styles.footer} role="banner">
      <div className={styles.inner}>
        <div className={styles.top_inner}>
          <div className={styles.top_inner_left}>
            <div className={styles.title}>
              SK쉴더스의
              <br />
              전문가와 상담하세요
              <div className={styles.desc}>
                원하는 상담 내용과 간단한 정보를 남겨주시면 전문 상담사가 도와드리겠습니다.
              </div>
            </div>
          </div>
          <div className={styles.top_inner_center}>
            <span>전화상담</span>
            <span>1800-6400</span>
            <span>평일 09:00~18:00 일요일/공휴일 휴무</span>
          </div>
          <div className={styles.top_inner_right}>
        ...
        <div className={styles.bottom_inner}>
          <div className={styles.bottom_inner_left}>
            <div className={styles.title}>에스케이쉴더스 주식회사</div>
            <div>
              <div>
            ...
            <div>
              <div>
                인증범위] SK쉴더스 대표홈페이지 및 홈보안/물리보안/정보보안/융합보안/케어 서비스
                운영 [유효기간] 2023-08-02 ~ 2026-08-01
              </div>
            </div>
            <div>
          ...
          <div className={styles.bottom_inner_center}>
            <div className={styles.family_link_list}>
              {Object.values(familyLinkGroups).map((item, index) => (
                <div className={styles.family_link_list_item} key={index}>
                  {item.map((link, linkIdx) => (
                    <Link
                      className={styles.family_link_link}
                      href={link.href}
                      key={linkIdx}
                      passHref
                    >
          ...
          <div className={styles.bottom_inner_right}>
            <MzSelectBox
              type="default"
              size="5"
              options={options}
