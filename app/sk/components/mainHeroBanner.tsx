        ...
        {data.map((item, index) => (
          ...
          >
            ...
            >
              ...
              >
                <h2 className={S.heroBanner__title}>
                  {isDesktop ? item.pcTitle : item.mobileTitle}
                </h2>
                ...
                <div
                  className={S.heroBanner__actions}
                  style={{
                ...
                >
                  {item.detailUrl && (
                    <MzButton
                      ...
                      fill="transparent"
                      href={item.detailUrl}
                      className={`${S.heroBanner__link} button-more`}
                      aria-label={`${isDesktop ? item.pcTitle : item.mobileTitle} 자세히 보기`}
                    >
                      자세히 보기
                      <i
                  ...
                  {item.downloadUrl && (
                    <MzButton
                      ...
                      className={`${S.heroBanner__link} button-more`}
                      aria-label={`${isDesktop ? item.pcTitle : item.mobileTitle} 상담하기`}
                      style={{ gap: 8 }}
                    >
                      상담하기
                    </MzButton>
